...
public class SwitchButton extends View implements Checkable {
    ...
    private void init(Context context, AttributeSet attrs) {
         ...
         * VIP换肤
         * */
        background = ThemeUtil.getThemeColorById(R.color.pool_text_color_light);
        uncheckColor = ThemeUtil.getThemeColorById(R.color.pool_text_color_light);
        checkedColor = ThemeUtil.getThemeColorById(R.color.pool_text_color_select);
        uncheckCircleColor = ThemeUtil.getThemeColorById(R.color.text_color_white);
